...
class DashboardPost(models.Model):
    machine_name = models.CharField(primary_key=True, max_length=100)
    work_no = models.CharField(max_length=100, blank=True, null=True)
    principal = models.CharField(max_length=100, blank=True, null=True)
    production_capacity = models.DecimalField(max_digits=10, decimal_places=0, blank=True, null=True)
    need_production_capacity = models.DecimalField(max_digits=10, decimal_places=0, blank=True, null=True)
    check_nums = models.DecimalField(max_digits=10, decimal_places=0, blank=True, null=True)
    speed = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    good_production = models.DecimalField(max_digits=10, decimal_places=0, blank=True, null=True)
    fiex_time = models.DateTimeField(blank=True, null=True)
